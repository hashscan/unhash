...
export const ProgressBar = ({
  ...
  width = '40px',
  className,
}: Partial<{ color: string; height: string | number; width: string | number; className?: string }>) => {
  return (
    <svg className={className} x="0px" y="0px" width={width} height={height} viewBox="0 0 50 50" xmlSpace="preserve">
      <path
        fill={color}
